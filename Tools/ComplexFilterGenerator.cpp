...
void GenerateHeaderFile(AbstractFilter* filter, const QString& outputDir, const QString& pluginName)
{
  ...
  const QString k_SIMPLToComplexToken("// {insert DREAM3D UUID here, insert DREAM3DNX UUID here}, // dream3d-class-name");
  const QString k_ComplexToSIMPLToken("// {insert DREAM3DNX UUID here, insert DREAM3D UUID here}, // dream3dnx-class-name");
  ...
  sourceTemplate = sourceTemplate.replace(k_SIMPLToComplexToken, "{\"" + prevUuid + "\", \"" + uuid + "\"}, // " + filterName + "\n    " + k_SIMPLToComplexToken);
  sourceTemplate = sourceTemplate.replace(k_ComplexToSIMPLToken, "{\"" + uuid + "\", \"" + prevUuid + "\"}, // " + filterName + "Filter\n    " + k_ComplexToSIMPLToken);
