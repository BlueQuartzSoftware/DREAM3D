...
function(InitializeCacheFile)
  ...
  FILE(APPEND ${cacheFile} "HDF5_hdf5_cpp_LIBRARY_${upper}:FILEPATH=${SDK_INSTALL}/${I_HDF_INSTALL}/bin/hdf5_cpp${DEBUG_PREFIX}.dll\n")

  set(upper "RELEASE")
  FILE(APPEND ${cacheFile} "HDF5_hdf5_LIBRARY_${upper}:FILEPATH=${SDK_INSTALL}/${I_HDF_INSTALL}/bin/hdf5.dll\n")
  FILE(APPEND ${cacheFile} "HDF5_hdf5_cpp_LIBRARY_${upper}:FILEPATH=${SDK_INSTALL}/${I_HDF_INSTALL}/bin/hdf5_cpp.dll\n")
