...
then
  ...
  echo " Please set the destination to ${DREAM3D_SDK}/Qt5.4.2"
  echo " When completed, rerun this script."
  echo "-------------------------------------------"
...
${SDK_INSTALL}/Build_Qwt.sh
rm ${SDK_INSTALL}/Build_Qwt.sh

${SDK_INSTALL}/Build_Eigen.sh
rm ${SDK_INSTALL}/Build_Eigen.sh

${SDK_INSTALL}/Build_HDF5.sh
rm ${SDK_INSTALL}/Build_HDF5.sh

${SDK_INSTALL}/Build_TBB.sh
...
#${SDK_INSTALL}/FixITK.sh
rm ${SDK_INSTALL}/FixITK.sh

${SDK_INSTALL}/Build_Boost.sh
