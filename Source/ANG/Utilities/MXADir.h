...
// -----------------------------------------------------------------------------
...
#if defined (WIN32)
    static TSLANG_EXPORT const char Separator = '\\';
#else
    static TSLANG_EXPORT const char Separator = '/';
#endif
    static TSLANG_EXPORT const char UnixSeparator = '/';
    static TSLANG_EXPORT const char Dot = '.';


    static TSLANG_EXPORT std::string getSeparator();
    /**
     * @brief Is the path specified a directory on the filesystem
     * @param path Path to examine
     */
    static TSLANG_EXPORT bool isDirectory(const std::string &path);

    /**
     * @brief Does the path designate a file on the file system
     * @param path Path to examine
     */
    static TSLANG_EXPORT bool isFile(const std::string &path);
     ...
     */
    static TSLANG_EXPORT bool isRelativePath(const std::string &path);
     ...
     */
    static TSLANG_EXPORT bool isAbsolutePath(const std::string &path);

    /**
     * @brief Returns the current path
     * @return The current working directory as reported by the operating system
     */
    static TSLANG_EXPORT std::string currentPath();
     ...
     */
    static TSLANG_EXPORT std::string parentPath(const std::string &path);
     ...
     */
    static TSLANG_EXPORT std::string absolutePath(const std::string &path);

    /**
     * @brief Does the path actually exist on the file system
     * @param path Path to examine
     */
    static TSLANG_EXPORT bool exists(const std::string &path);
     ...
     */
    static TSLANG_EXPORT std::string cleanPath(const std::string &path);
     ...
     */
    static TSLANG_EXPORT std::string fromNativeSeparators(const std::string  &path);
     ...
     */
    static TSLANG_EXPORT std::string toNativeSeparators(const std::string &path);

#if defined (WIN32)
    static TSLANG_EXPORT bool isDirPath(const std::string &path, bool *existed);
#endif
...
// -----------------------------------------------------------------------------
     ...
     */
    static TSLANG_EXPORT std::vector<std::string> entryList(const std::string &path);
     ...
     */
    static TSLANG_EXPORT bool mkdir(const std::string &path, bool createParentDirectories);
     ...
     */
    static TSLANG_EXPORT bool rmdir(const std::string &path, bool recurseParentDirectories);
     ...
     */
    static TSLANG_EXPORT bool remove(const std::string &path);
