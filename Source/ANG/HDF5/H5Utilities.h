...
public:
  ...
  static TSLANG_EXPORT hid_t openFile(const std::string &filename, bool readOnly=false);

  static TSLANG_EXPORT hid_t createFile(const std::string &filename);

  static TSLANG_EXPORT herr_t closeFile(hid_t &fileId);
  ...
  */
  static TSLANG_EXPORT std::string getObjectPath(hid_t objId, bool trim=false);
  ...
  */
  static TSLANG_EXPORT herr_t getObjectType(hid_t objId, const std::string &objName, int32_t *objType);
  ...
  */
  static TSLANG_EXPORT herr_t objectNameAtIndex(hid_t fileId, int32_t idx, std::string &name);
  ...
  */
  static TSLANG_EXPORT bool isGroup(hid_t objId, const std::string &objName);
  ...
  */
  static TSLANG_EXPORT hid_t openHDF5Object(hid_t locId, const std::string &objectPath);
  ...
  * @return Negative value is error.
  */
  static TSLANG_EXPORT herr_t closeHDF5Object(hid_t locId);


  static TSLANG_EXPORT std::string HDFClassTypeAsStr(hid_t class_type);

  /**
  * @brief prints the class type of the given class
  * @param classT The Class Type to print
  */
  static TSLANG_EXPORT void printHDFClassType(H5T_class_t classT);
  ...
  * @return
  */
  static TSLANG_EXPORT herr_t getGroupObjects(hid_t loc_id, int32_t typeFilter, std::list<std::string>& names);
   ...
   */
  static TSLANG_EXPORT hid_t createGroup(hid_t loc_id, const std::string &group);
   ...
   */
  static TSLANG_EXPORT herr_t  createGroupsFromPath(const std::string &pathToCheck, hid_t parent);
   ...
   * @return Error Condition: Negative is error. Positive is success.
   */
  static TSLANG_EXPORT herr_t createGroupsForDataset(const std::string &datasetPath, hid_t parent);
  ...
  */
  static TSLANG_EXPORT std::string extractObjectName(const std::string &path);
  ...
  */
  static TSLANG_EXPORT bool probeForAttribute(hid_t loc_id,
  ...
  */
  static TSLANG_EXPORT herr_t getAllAttributeNames(hid_t objId, std::list<std::string> &names);
  ...
  * @return Negative value is error
  */
  static TSLANG_EXPORT herr_t getAllAttributeNames(hid_t objId, const std::string &obj_name,
   ...
   * @return Negative value on error
   */
  static TSLANG_EXPORT herr_t readAllAttributes(hid_t fileId,
