...
extern "C" {
#endif
  herr_t TSLANG_EXPORT find_attr( hid_t loc_id, const char *name, void *op_data);

  herr_t TSLANG_EXPORT find_dataset( hid_t loc_id, const char *name, void *op_data);
...
public:
   ...
   * H5Lite.h
   */
  static TSLANG_EXPORT void disableErrorHandlers();
 ...
 */
static TSLANG_EXPORT herr_t openId( hid_t loc_id, const std::string& objName, int32_t obj_type);
 ...
 * @return Standard HDF5 Error Conditions
 */
static TSLANG_EXPORT herr_t closeId( hid_t obj_id, int32_t obj_type );
 ...
 */
static TSLANG_EXPORT herr_t findAttribute( hid_t loc_id, const std::string& attrName );
 ...
 * @return Standard HDF5 Error condition
 */
static TSLANG_EXPORT herr_t findDataset( hid_t loc_id, const std::string& name );
 ...
 * @return Standard HDF5 error conditions
 */
static TSLANG_EXPORT herr_t  writeStringDataset (hid_t loc_id,
                                        const std::string& dsetName,
 ...
 */
static TSLANG_EXPORT herr_t  writeStringAttribute(hid_t loc_id,
                              const std::string& objName,
                              const std::string& attrName,
                              const std::string& data);
/**
 ...
 * @return Standard HDF error condition
 */
static TSLANG_EXPORT herr_t writeStringAttributes(hid_t loc_id,
                                     const std::string &objName,
 ...
 * @return Standard HDF error condition
 */
static TSLANG_EXPORT herr_t readStringDataset(hid_t loc_id,
                                     const std::string& dsetName,
                                     std::string &data);
 ...
 * @return Standard HDF Error condition
 */
static TSLANG_EXPORT herr_t readStringAttribute(hid_t loc_id,
                                             const std::string& objName,
                                             const std::string& attrName,
                                             std::string &data);
 ...
 */
static TSLANG_EXPORT hid_t getAttributeNDims(hid_t loc_id, const std::string& objName, const std::string& attrName, hid_t &rank);
 ...
 * @param rank (out) Number of dimensions is store into this variable
 */
static TSLANG_EXPORT hid_t getDatasetNDims(hid_t loc_id, const std::string& objName, hid_t &rank);
 ...
 * @return
 */
static TSLANG_EXPORT hid_t getDatasetType(hid_t loc_id, const std::string &dsetName);
 ...
 */
static TSLANG_EXPORT herr_t getDatasetInfo( hid_t loc_id,
                              const std::string& dsetName,
                              std::vector<hsize_t> &dims,
                              H5T_class_t &type_class,
                              size_t &type_size );
 ...
 * @return
 */
static TSLANG_EXPORT herr_t getAttributeInfo(hid_t loc_id,
                               const std::string& objName,
 ...
 * @return Standard hdf5 error condition
 */
static TSLANG_EXPORT herr_t writeMXAArray(hid_t loc_id,
                            const std::string &dsetName,
                            IMXAArray* array);
/**
 * @brief Writes the data contained within an IMXAArray object into an hdf5 file
 ...
 * @return Standard hdf5 error condition
 */
static TSLANG_EXPORT herr_t writeMXAAttribute(hid_t loc_id,
                            const std::string &dsetName,
 ...
 */
static TSLANG_EXPORT IMXAArray* readMXAArray(hid_t loc_id,
                           const std::string &dsetName );
 ...
 * @return IMXAArray Pointer. NULL value is possible on error
 */
static TSLANG_EXPORT IMXAArray* readMXAAttribute(hid_t loc_id,
                                   const std::string &dsetName,
                                   const std::string &attributeKey);
