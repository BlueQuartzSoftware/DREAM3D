...
int ***voxels;
int *graincheck;
vector<vector<int>> nodesvector;
vector<vector<int>> trianglesvector;
vector<vector<int>> gvector;
vector<vector<int>> tvector;
vector<vector<int>> nnvector;
vector<vector<int>> elvector;
 ...
 for(int a=1;a<numgrains+1;a++)
 {
	 ...
	 for(int b=0;b<6;b++)
	 {
		...
		for(int c=0;c<500;c++)
		{
			...
			{
					double initval = 0;
					if(b == 0 || b == 2 || b == 4) initval = 10000000;
					if(b == 1 || b == 3 || b == 5) initval = 0;
...
for(int idea=0;idea<numcycles;idea++)
{
 ...
 read_elements(idea);
 if(idea < (numcycles-1)) delete []element;
}
 measure_elements();
// improve_mesh();
// measure_elements();
...
void read_nodes(string inname1)
{
	...
	for(int i=0;i<numsurfnodes;i++)
	{
		...
		if(ngrains > 2) originalnode[nodenum].set_triplenode(tnode);
	}
}
...
void read_triangles(string inname3)
{
	...
	for(int i=0;i<numtriangles;i++)
	{
		...
		if(grain1 < 0) grain1 = 0, onedge = 1;
		if(grain2 < 0) grain2 = 0, onedge = 1;
		...
		if((originalnode[node1].triplenode+originalnode[node2].triplenode+originalnode[node3].triplenode) >= 2) originaltriangle[trianglenum].set_tripletriangle(ttriangle);
	}
...
void locate_graincenters()
{
	...
	for(int i=1;i<numgrains+1;i++)
	{
		...
		for(int j=0;j<size;j++)
		{
			...
			if(originalnode[snode].edgenode == 1) onedge = 1;
		}
...
void delete_triangles()
{
	...
	for(int i=0;i<numtriangles;i++)
	{
		if(originaltriangle[i].trianglekilled != 1 && originaltriangle[i].edgetriangle != 1)
		{
			...
			if(edgelength1 <= edgelength2 && edgelength1 <= edgelength3) edgeorder[0] = 1;
			if(edgelength2 <= edgelength1 && edgelength2 <= edgelength3) edgeorder[0] = 2;
			if(edgelength3 <= edgelength1 && edgelength3 <= edgelength2) edgeorder[0] = 3;
			if(edgeorder[0] == 1 && edgelength2 <= edgelength3) edgeorder[1] = 2, edgeorder[2] = 3;
			if(edgeorder[0] == 1 && edgelength3 <= edgelength2) edgeorder[1] = 3, edgeorder[2] = 2;
			if(edgeorder[0] == 2 && edgelength1 <= edgelength3) edgeorder[1] = 1, edgeorder[2] = 3;
			if(edgeorder[0] == 2 && edgelength3 <= edgelength1) edgeorder[1] = 3, edgeorder[2] = 1;
			if(edgeorder[0] == 3 && edgelength1 <= edgelength2) edgeorder[1] = 1, edgeorder[2] = 2;
			if(edgeorder[0] == 3 && edgelength2 <= edgelength1) edgeorder[1] = 2, edgeorder[2] = 1;
			int size = 0;
			...
			while(!affectedtrianglelist.empty() && keep == 0)
			{
				...
				if(originaltriangle[trianglenum].trianglekilled != 1)
				{
					...
					int normalfix2 = 1;
					if(leftgrain1 == leftgrain2) normalfix2 = 1;
					if(leftgrain1 == rightgrain2) normalfix2 = -1;
			...
			if(avgmisorient <= 172.5) keep = 1;
			if(originaltriangle[i].trianglearea < (0.25*avgarea)) keep = 0;
			if(keep == 0)
			{
				count++;
				if(edgeorder[0] == 1)
				{
					...
					for(int l=0;l<size;l++)
					{
						...
						if(originaltriangle[firsttriangle].trianglekilled != 1)
						{
							...
							if(n1 == node2) n1 = node1, affected = 1;
							if(n2 == node2) n2 = node1, affected = 1;
							if(n3 == node2) n3 = node1, affected = 1;
							originaltriangle[firsttriangle].set_nodes_leftgrain(n1,n2,n3);
							originaltriangle[firsttriangle].set_nodes_rightgrain(n1,n3,n2);
							if(n1 == n2 || n1 == n3 || n2 == n3) originaltriangle[firsttriangle].set_killed(killed);
							...
							double length1 = ((originalnode[n1].xc-originalnode[n2].xc)*(originalnode[n1].xc-originalnode[n2].xc))+((originalnode[n1].yc-originalnode[n2].yc)*(originalnode[n1].yc-originalnode[n2].yc))+((originalnode[n1].zc-originalnode[n2].zc)*(originalnode[n1].zc-originalnode[n2].zc));
							length1 = pow(length1,0.5);
							double length2 = ((originalnode[n1].xc-originalnode[n3].xc)*(originalnode[n1].xc-originalnode[n3].xc))+((originalnode[n1].yc-originalnode[n3].yc)*(originalnode[n1].yc-originalnode[n3].yc))+((originalnode[n1].zc-originalnode[n3].zc)*(originalnode[n1].zc-originalnode[n3].zc));
							length2 = pow(length2,0.5);
							double length3 = ((originalnode[n2].xc-originalnode[n3].xc)*(originalnode[n2].xc-originalnode[n3].xc))+((originalnode[n2].yc-originalnode[n3].yc)*(originalnode[n2].yc-originalnode[n3].yc))+((originalnode[n2].zc-originalnode[n3].zc)*(originalnode[n2].zc-originalnode[n3].zc));
							length3 = pow(length3,0.5);
							double avglength = (length1+length2+length3)/3.0;
							double maxlength = length1;
							if(length2 > maxlength) maxlength = length2;
							if(length3 > maxlength) maxlength = length3;
				...
				if(edgeorder[0] == 2)
				{
					...
					for(int l=0;l<size;l++)
					{
						...
						if(originaltriangle[firsttriangle].trianglekilled != 1)
						{
							...
							int n2 = originaltriangle[firsttriangle].secondnodeleft;
							int n3 = originaltriangle[firsttriangle].thirdnodeleft;
							if(n1 == node3) n1 = node1, affected = 1;
							if(n2 == node3) n2 = node1, affected = 1;
							if(n3 == node3) n3 = node1, affected = 1;
							originaltriangle[firsttriangle].set_nodes_leftgrain(n1,n2,n3);
							originaltriangle[firsttriangle].set_nodes_rightgrain(n1,n3,n2);
							if(n1 == n2 || n1 == n3 || n2 == n3) originaltriangle[firsttriangle].set_killed(killed);
							if(affected == 1 && originaltriangle[firsttriangle].trianglekilled != 1)
				...
				if(edgeorder[0] == 3)
				{
					...
					for(int l=0;l<size;l++)
					{
						...
						if(originaltriangle[firsttriangle].trianglekilled != 1)
						{
							...
							int n2 = originaltriangle[firsttriangle].secondnodeleft;
							int n3 = originaltriangle[firsttriangle].thirdnodeleft;
							if(n1 == node3) n1 = node2, affected = 1;
							if(n2 == node3) n2 = node2, affected = 1;
							if(n3 == node3) n3 = node2, affected = 1;
							originaltriangle[firsttriangle].set_nodes_leftgrain(n1,n2,n3);
							originaltriangle[firsttriangle].set_nodes_rightgrain(n1,n3,n2);
							if(n1 == n2 || n1 == n3 || n2 == n3) originaltriangle[firsttriangle].set_killed(killed);
							if(affected == 1 && originaltriangle[firsttriangle].trianglekilled != 1)
	...
	while(count > 0)
	{
		...
		for(int j=0;j<numtriangles;j++)
		{
			if(originaltriangle[j].trianglekilled != 1  && originaltriangle[j].edgetriangle != 1)
			{
				...
				int badangle = 0;
				if(angle1 < 20) badangle = 1;
				if(angle2 < 20) badangle = 2;
				if(angle3 < 20) badangle = 3;
				if(badangle == 1)
				{
					count++;
					if(originalnode[node3].numgrains > originalnode[node2].numgrains)
...
void create_finalnodesandtriangles()
{
	...
	for(int i=0;i<numsurfnodes;i++)
	{
		...
		if(originalnode[i].nodekilled != 1)
		{
			...
			if(x != globalxmin && x != globalxmax) x = x+(random1*0.01);
			if(y != globalymin && y != globalymax) y = y-(random1*0.01);
			if(z != globalzmin && z != globalzmax) z = z+(random1*0.01);
...
void find_volumes()
{
	...
	for(int i=1;i<numgrains+1;i++)
	{
		...
		for(int j=0;j<size;j++)
		{
			...
			if(finalnode[firstnode].xc < minx) minx = finalnode[firstnode].xc;
			if(finalnode[firstnode].xc > maxx) maxx = finalnode[firstnode].xc;
			if(finalnode[firstnode].yc < miny) miny = finalnode[firstnode].yc;
			if(finalnode[firstnode].yc > maxy) maxy = finalnode[firstnode].yc;
			if(finalnode[firstnode].zc < minz) minz = finalnode[firstnode].zc;
			if(finalnode[firstnode].zc > maxz) maxz = finalnode[firstnode].zc;
		}
		...
		for(int j=0;j<size;j++)
		{
			...
			if(finaltriangle[firsttriangle].trianglekilled != 1)
			{
				...
				if(rightgrain == i) finaltriangle[firsttriangle].set_vol_rightgrain(vol);
...
//	outFile.open(fileout);
	...
	for(int l=0;l<size;l++)
	{
		...
		if(finaltriangle[firsttriangle].trianglekilled != 1)
		{
			...
			if(xstop > 500) xstop = 500;
			if(ystart < 0) ystart = 0;
			if(ystop > 500) ystop = 500;
			if(zstart < 0) zstart = 0;
			if(zstop > 500) zstop = 500;
			for(int i=xstart;i<xstop;i++)
			{
				for(int j=ystart;j<ystop;j++)
				{
					...
					if(in == 1)
					{
						...
						if(zval < zbuffer[iter][0][i][j]) zbuffer[iter][0][i][j] = zval;
						if(zval > zbuffer[iter][1][i][j]) zbuffer[iter][1][i][j] = zval;
					}
				}
			}
			for(int i=xstart;i<xstop;i++)
			{
				for(int j=zstart;j<zstop;j++)
				{
					...
					if(in == 1)
					{
						...
						if(yval < zbuffer[iter][2][i][j]) zbuffer[iter][2][i][j] = yval;
						if(yval > zbuffer[iter][3][i][j]) zbuffer[iter][3][i][j] = yval;
					}
				}
			}
			for(int i=ystart;i<ystop;i++)
			{
				for(int j=zstart;j<zstop;j++)
				{
					...
					if(in == 1)
					{
						...
						if(xval < zbuffer[iter][4][i][j]) zbuffer[iter][4][i][j] = xval;
						if(xval > zbuffer[iter][5][i][j]) zbuffer[iter][5][i][j] = xval;
					}
				}
			}
		}
	...
	for(int i=0;i<numxvoxels;i++)
	{
		for(int j=0;j<numyvoxels;j++)
		{
			for(int k=0;k<numzvoxels;k++)
			{
				...
				{
					if(x >= zbuffer[iter][4][jbin][kbin] && x <= zbuffer[iter][5][jbin][kbin] && y >= zbuffer[iter][2][ibin][kbin] && y <= zbuffer[iter][3][ibin][kbin] && z >= zbuffer[iter][0][ibin][jbin] && z <= zbuffer[iter][1][ibin][jbin])
					{
						voxels[i][j][k] = iter;
					}
				}
	...
	while(grainnodecount < 3500)
	{
		...
		{
			if(xp > zbuffer[iter][4][y][z] && xp < zbuffer[iter][5][y][z] && yp > zbuffer[iter][2][x][z] && yp < zbuffer[iter][3][x][z] && zp > zbuffer[iter][0][x][y] && zp < zbuffer[iter][1][x][y])
			{
				dist = xp-zbuffer[iter][4][y][z];
				if((zbuffer[iter][5][y][z]-xp) < dist) dist = (zbuffer[iter][5][y][z]-xp);
				if((yp-zbuffer[iter][2][x][z]) < dist) dist = (yp-zbuffer[iter][2][x][z]);
				if((zbuffer[iter][3][x][z]-yp) < dist) dist = (zbuffer[iter][3][x][z]-yp);
				if((zp-zbuffer[iter][0][x][y]) < dist) dist = (zp-zbuffer[iter][0][x][y]);
	...
	for(int i=0;i<numelements;i++)
	{
		...
		if(idea < numcycles-1)
		{
			for(int l=0;l<size1;l++)
			{
				...
				if(find(gvector[n2].begin(), gvector[n2].end(), gnum1) != gvector[n2].end()) good12 = 1;
				if(find(gvector[n3].begin(), gvector[n3].end(), gnum1) != gvector[n3].end()) good13 = 1;
				if(find(gvector[n4].begin(), gvector[n4].end(), gnum1) != gvector[n4].end()) good14 = 1;
			}
			for(int l=0;l<size2;l++)
			{
				int gnum2 = gvector[n2][l];
				if(find(gvector[n3].begin(), gvector[n3].end(), gnum2) != gvector[n3].end()) good23 = 1;
				if(find(gvector[n4].begin(), gvector[n4].end(), gnum2) != gvector[n4].end()) good24 = 1;
			}
			for(int l=0;l<size3;l++)
			{
				int gnum3 = gvector[n3][l];
				if(find(gvector[n4].begin(), gvector[n4].end(), gnum3) != gvector[n4].end()) good34 = 1;
			}
			if(good12 == 0)
			{
				if(size1 == 1 && size2 == 1)
				{
					...
					for(int l=0;l<size;l++)
					{
						...
						double denominator = (((ux*vx)+(uy*vy)+(uz*vz))*((ux*vx)+(uy*vy)+(uz*vz)))-(((ux*ux)+(uy*uy)+(uz*uz))*((vx*vx)+(vy*vy)+(vz*vz)));
						double snumerator = (((ux*vx)+(uy*vy)+(uz*vz))*((wx*vx)+(wy*vy)+(wz*vz)))-(((wx*ux)+(wy*uy)+(wz*uz))*((vx*vx)+(vy*vy)+(vz*vz)));
						double tnumerator = (((ux*vx)+(uy*vy)+(uz*vz))*((wx*ux)+(wy*uy)+(wz*uz)))-(((wx*vx)+(wy*vy)+(wz*vz))*((ux*ux)+(uy*uy)+(uz*uz)));
					...
					if(move == 1)
					{
						for(int l=0;l<size2;l++)
						{
							...
							if(find(gvector[n1].begin(), gvector[n1].end(), firstgrain) == gvector[n1].end()) gvector[n1].push_back(firstgrain);
						}
					...
					if(move == 2)
					{
						for(int l=0;l<size1;l++)
						{
							...
							if(find(gvector[n2].begin(), gvector[n2].end(), firstgrain) == gvector[n2].end()) gvector[n2].push_back(firstgrain);
						}
			...
			if(good13 == 0)
			{
				if(size1 == 1 && size3 == 1)
				{
					...
					if(move == 2)
					{
						...
						{
							int firstgrain = gvector[n1][l];
							if(find(gvector[n3].begin(), gvector[n3].end(), firstgrain) == gvector[n3].end()) gvector[n3].push_back(firstgrain);
						}
						...
						{
							int gnum3 = gvector[n3][l];
							if(find(gvector[n2].begin(), gvector[n2].end(), gnum3) != gvector[n2].end()) good23 = 1;
							if(find(gvector[n4].begin(), gvector[n4].end(), gnum3) != gvector[n4].end()) good34 = 1;
						}
			...
			if(good14 == 0)
			{
				if(size1 == 1 && size4 == 1)
				{
					...
					if(move == 2)
					{
						...
						{
							int firstgrain = gvector[n1][l];
							if(find(gvector[n4].begin(), gvector[n4].end(), firstgrain) == gvector[n4].end()) gvector[n4].push_back(firstgrain);
						}
						...
						for(int l=0;l<size4;l++)
						{
							...
							if(find(gvector[n2].begin(), gvector[n2].end(), gnum4) != gvector[n2].end()) good24 = 1;
							if(find(gvector[n3].begin(), gvector[n3].end(), gnum4) != gvector[n3].end()) good34 = 1;
						}
		...
		if(finalnode[n1].edgenode == 1 || finalnode[n2].edgenode == 1 || finalnode[n3].edgenode == 1 || finalnode[n4].edgenode == 1) onedge = 1;
		size1 = gvector[n1].size();
		size2 = gvector[n2].size();
		size3 = gvector[n3].size();
		size4 = gvector[n4].size();
		for(int l=0;l<size1;l++)
		{
			...
			graincheck[gnum]++;
			if(graincheck[gnum] == 4) pickedgrain = gnum;
		}
		for(int l=0;l<size2;l++)
		{
	...
	for(int i=0;i<numelements;i++)
	{
		...
		if(grainnum < 0)
		{
			...
			if(pickedgrain == -1 && doit == 1)
			{
				int newnode = n1;
				int maxsize = size1;
				if(size2 > maxsize) newnode = n2, maxsize = size2;
				if(size3 > maxsize) newnode = n3, maxsize = size3;
				if(size4 > maxsize) newnode = n4, maxsize = size4;
				if(newnode != n1) finalnode[n1].set_killed(killed);
				if(newnode != n2) finalnode[n2].set_killed(killed);
				if(newnode != n3) finalnode[n3].set_killed(killed);
				if(newnode != n4) finalnode[n4].set_killed(killed);
				...
				for(int l=0;l<size;l++)
				{
					...
					if(node1 == n1 || node1 == n2 || node1 == n3 || node1 == n4) count1++;
					if(node2 == n1 || node2 == n2 || node2 == n3 || node2 == n4) count2++;
					if(node3 == n1 || node3 == n2 || node3 == n3 || node3 == n4) count3++;
					if(node4 == n1 || node4 == n2 || node4 == n3 || node4 == n4) count4++;
					...
					{
						if(count1 == 1) element[elem].set_nodes(newnode,node2,node3,node4);
						if(count2 == 1) element[elem].set_nodes(node1,newnode,node3,node4);
						if(count3 == 1) element[elem].set_nodes(node1,node2,newnode,node4);
						if(count4 == 1) element[elem].set_nodes(node1,node2,node3,newnode);
					}
				}
...
void measure_elements()
{
	...
	for(int k=0;k<elementcount;k++)
	{
		if(element[k].elementkilled != 1)
		{
			...
			if(grainname > 0) grainvol[grainname] = grainvol[grainname]+vol;
			avgvol = avgvol + vol;
			count++;
		}
	}
	...
	while(count > 0)
	{
		...
		for(int i=0;i<elementcount;i++)
		{
			...
			if(element[i].elementkilled != 1)
			{
				...
				if(dihedralangle1 < 10 || dihedralangle1 > 170 || dihedralangle2 < 10 || dihedralangle2 > 170 || dihedralangle3 < 10 || dihedralangle3 > 170 || dihedralangle4 < 10 || dihedralangle4 > 170 || dihedralangle5 < 10 || dihedralangle5 > 170 || dihedralangle6 < 10 || dihedralangle6 > 170)
...
//				if(dihedralangle1 < 20 || dihedralangle1 > 160 || dihedralangle2 < 20 || dihedralangle2 > 160 || dihedralangle3 < 20 || dihedralangle3 > 160 || dihedralangle4 < 20 || dihedralangle4 > 160 || dihedralangle5 < 20 || dihedralangle5 > 160 || dihedralangle6 < 20 || dihedralangle6 > 160)
				{
					...
					edgetokill = 1;
					if(minedgelength > element[i].edgelength2) minedgelength = element[i].edgelength2, edgetokill = 2;
					if(minedgelength > element[i].edgelength3) minedgelength = element[i].edgelength3, edgetokill = 3;
					if(minedgelength > element[i].edgelength4) minedgelength = element[i].edgelength4, edgetokill = 4;
					...
					if(edgetokill == 1)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							if(n2 == node2) n2 = node1, affected = 1;
							if(n3 == node2) n3 = node1, affected = 1;
							if(n4 == node2) n4 = node1, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
...
//							node[node1].set_coords(nx,ny,nz);
					...
					if(edgetokill == 2)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							if(n2 == node3) n2 = node1, affected = 1;
							if(n3 == node3) n3 = node1, affected = 1;
							if(n4 == node3) n4 = node1, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
							if(element[firstelement].elementkilled != 1)
							{
...
//							node[node1].set_coords(nx,ny,nz);
					...
					if(edgetokill == 3)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							int n3 = element[firstelement].node3;
							int n4 = element[firstelement].node4;
							if(n1 == node4) n1 = node1, affected = 1;
							if(n2 == node4) n2 = node1, affected = 1;
							if(n3 == node4) n3 = node1, affected = 1;
							if(n4 == node4) n4 = node1, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
							if(element[firstelement].elementkilled != 1)
							{
...
//							node[node1].set_coords(nx,ny,nz);
					...
					if(edgetokill == 4)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							if(n2 == node3) n2 = node2, affected = 1;
							if(n3 == node3) n3 = node2, affected = 1;
							if(n4 == node3) n4 = node2, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
							if(element[firstelement].elementkilled != 1)
							{
...
//							node[node2].set_coords(nx,ny,nz);
					...
					if(edgetokill == 5)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							int n3 = element[firstelement].node3;
							int n4 = element[firstelement].node4;
							if(n1 == node4) n1 = node2, affected = 1;
							if(n2 == node4) n2 = node2, affected = 1;
							if(n3 == node4) n3 = node2, affected = 1;
							if(n4 == node4) n4 = node2, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
							if(element[firstelement].elementkilled != 1)
							{
...
//							node[node2].set_coords(nx,ny,nz);
					...
					if(edgetokill == 6)
					{
						...
						for(int l=0;l<size;l++)
						{
							...
							int n3 = element[firstelement].node3;
							int n4 = element[firstelement].node4;
							if(n1 == node4) n1 = node3, affected = 1;
							if(n2 == node4) n2 = node3, affected = 1;
							if(n3 == node4) n3 = node3, affected = 1;
							if(n4 == node4) n4 = node3, affected = 1;
							element[firstelement].set_nodes(n1,n2,n3,n4);
							if(n1 == n2 || n1 == n3 || n1 == n4 || n2 == n3 || n2 == n4 || n3 == n4) element[firstelement].set_killed(killed);
							if(element[firstelement].elementkilled != 1)
							{
...
//		if(gvector[j].size() != 1) outFile << "0" << endl;
	...
	for(int i=0;i<elementcount;i++)
	{
		if(element[i].elementkilled != 1)
		{
			...
			if((dihedral2) < worstangle) worstangle = (dihedral2);
			if((dihedral3) < worstangle) worstangle = (dihedral3);
