...
class GeneratePrimaryStatsData : public AbstractFilter
{
  ...
  public:
    ...
    SIMPL_FILTER_PARAMETER(DataArrayPath, CreatedEnsembleAttributeMatrixPath)
    Q_PROPERTY(DataArrayPath CreatedEnsembleAttributeMatrixPath READ getCreatedEnsembleAttributeMatrixPath WRITE setCreatedEnsembleAttributeMatrixPath)
