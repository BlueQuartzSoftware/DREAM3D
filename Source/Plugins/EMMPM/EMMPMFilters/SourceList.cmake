...
set(_filterGroupName EMMPMFilters)
set(${_filterGroupName}_FILTERS_HDRS "")

#--------
# This macro must come first before we start adding any filters
START_FILTER_GROUP(${EMMPM_BINARY_DIR} "${_filterGroupName}" "EMMPM")
...
foreach(f ${_PublicFilters} )
  ADD_DREAM3D_FILTER(  "EMMPM" "EMMPM"
                        ${_filterGroupName} ${f}
...
END_FILTER_GROUP(${EMMPM_BINARY_DIR} "${_filterGroupName}" "EMMPM")
