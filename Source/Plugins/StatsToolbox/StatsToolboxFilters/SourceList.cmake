...
set(_filterGroupName StatsToolboxFilters)
...
foreach(f ${_PublicFilters} )
  ADD_SIMPL_FILTER(  "StatsToolbox" "StatsToolbox"
                        ${_filterGroupName} ${f}
                        ${StatsToolbox_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE)
endforeach()
...
SIMPL_END_FILTER_GROUP(${StatsToolbox_BINARY_DIR} "${_filterGroupName}" "StatsToolbox Filters")
