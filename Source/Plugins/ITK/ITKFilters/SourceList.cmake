...
set(_filterGroupName ITKFilters)
set(${_filterGroupName}_FILTERS_HDRS "")

#--------
# This macro must come first before we start adding any filters
START_FILTER_GROUP(${ITK_BINARY_DIR} "${_filterGroupName}" "ITK")
...
foreach(f ${_PublicFilters} )
  ADD_DREAM3D_FILTER(  "ITK" "ITK"
                        ${_filterGroupName} ${f}
                        ${ITK_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE)
endforeach()
