...
public:
  ...
  {
    // Now instantiate the GridifyTest Filter from the FilterManager
    QString filtName = "Gridify";
    FilterManager* fm = FilterManager::Instance();
    IFilterFactory::Pointer filterFactory = fm->getFactoryFromClassName(filtName);
    if(nullptr == filterFactory.get())
    {
      std::stringstream ss;
      ss << "The GridifyTest Requires the use of the " << filtName.toStdString() << " filter which is found in the OrientationAnalysis Plugin";
  ...
  {
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    /* Please write GridifyTest test code here.
     *
     * Your IO test files are:
     * UnitTest::GridifyTest::TestFile1
     * UnitTest::GridifyTest::TestFile2
     *
  ...
  void operator()()
  {
    ...
    DREAM3D_REGISTER_TEST(TestGridifyTest())
