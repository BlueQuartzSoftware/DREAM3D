...
public:
  SIMPL_SHARED_POINTERS(FixNonmanifoldVoxels)
  SIMPL_FILTER_NEW_MACRO(FixNonmanifoldVoxels)
  SIMPL_TYPE_MACRO_SUPER(FixNonmanifoldVoxels, AbstractFilter)

  ~FixNonmanifoldVoxels() override;
