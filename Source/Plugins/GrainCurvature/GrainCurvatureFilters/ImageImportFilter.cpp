...
//
// -----------------------------------------------------------------------------
ImageImportFilter::ImageImportFilter() :
AbstractFilter()
{
...
//
// -----------------------------------------------------------------------------
void ImageImportFilter::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void ImageImportFilter::writeFilterParameters(AbstractFilterParametersWriter* writer)
{
...
//
// -----------------------------------------------------------------------------
void ImageImportFilter::dataCheck(bool preflight, size_t voxels, size_t fields, size_t ensembles)
{
  setErrorCondition(0);
...
//
// -----------------------------------------------------------------------------
void ImageImportFilter::preflight()
{
...
//
// -----------------------------------------------------------------------------
void ImageImportFilter::execute()
{
  int err = 0;
