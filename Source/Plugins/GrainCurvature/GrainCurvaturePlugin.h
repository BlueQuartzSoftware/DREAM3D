...
/**
 * @class GrainCurvaturePlugin GrainCurvaturePlugin.h SurfaceMeshing/GrainCurvaturePlugin.h
 * @brief
 * @author Michael A. Jackson for BlueQuartz Software
 * @date May 10, 2012
 * @version 1.0
 */
class GrainCurvaturePlugin : public QObject, public DREAM3DPluginInterface
{
    Q_OBJECT;
    Q_INTERFACES(DREAM3DPluginInterface)

  public:
    GrainCurvaturePlugin();
    virtual ~GrainCurvaturePlugin();
    /**
  ...
  private:
    GrainCurvaturePlugin(const GrainCurvaturePlugin&); // Copy Constructor Not Implemented
    void operator=(const GrainCurvaturePlugin&); // Operator '=' Not Implemented
};
