...
/**
 * @brief The ArrayCalculator class. See [Filter documentation](@ref arraycalculator) for details.
 */
class ArrayCalculator : public AbstractFilter
{
  ...
  public:
    ...
    SIMPL_FILTER_PARAMETER(QVector<DataArrayPath>, InputArrayNames)
    Q_PROPERTY(QVector<DataArrayPath> InputArrayNames READ getInputArrayNames WRITE setInputArrayNames)
    ...
    SIMPL_FILTER_PARAMETER(QString, Expression)
  ...
  private:
    DEFINE_DATAARRAY_VARIABLE(double, OutputArray)
