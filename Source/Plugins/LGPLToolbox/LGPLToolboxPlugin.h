...
#ifndef _LGPLToolbox_H_
#define _LGPLToolbox_H_
...
/**
 * @brief The LGPLToolboxPlugin class
 */
class LGPLToolboxPlugin : public QObject, public ISIMPLibPlugin
{
    Q_OBJECT
    Q_INTERFACES(ISIMPLibPlugin)
    Q_PLUGIN_METADATA(IID "com.your.domain.LGPLToolboxPlugin")

  public:
    LGPLToolboxPlugin();
    virtual ~LGPLToolboxPlugin();
  ...
  private:
    ...
    LGPLToolboxPlugin(const LGPLToolboxPlugin&); // Copy Constructor Not Implemented
    void operator=(const LGPLToolboxPlugin&); // Operator '=' Not Implemented
};

#endif /* _LGPLToolbox_H_ */
