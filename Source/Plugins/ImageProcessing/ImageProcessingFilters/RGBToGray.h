...
/**
 * @class RGBToGray RGBToGray.h ImageProcessing/Code/ImageProcessingFilters/RGBToGray.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class RGBToGray : public AbstractFilter
{
  public:
    DREAM3D_SHARED_POINTERS(RGBToGray);
    DREAM3D_STATIC_NEW_MACRO(RGBToGray);
    DREAM3D_TYPE_MACRO_SUPER(RGBToGray, AbstractFilter);
    ...
    DREAM3D_INSTANCE_PROPERTY(FloatVec3Widget_t, ColorWeights)
    ...
    */
    virtual const std::string getHumanLabel() { return "RGB To Grayscale"; }
  ...
  private:
    ...
    void operator=(const RGBToGray&); // Operator '=' Not Implemented
};
