...
/**
 * @class MultiOtsuThreshold MultiOtsuThreshold.h ImageProcessing/Code/ImageProcessingFilters/MultiOtsuThreshold.h
 * @brief
 * @author
 * @date
 * @version 1.0
...
class MultiOtsuThreshold : public AbstractFilter
{
  public:
    ...
    DREAM3D_INSTANCE_PROPERTY(int, Levels)
    ...
    */
    virtual const std::string getHumanLabel() { return "Multiple Otsu Threshold"; }
