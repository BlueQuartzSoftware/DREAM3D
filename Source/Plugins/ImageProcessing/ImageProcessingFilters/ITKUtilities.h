...
class DREAM3DLib_EXPORT ITKUtilities
{
  ...
  ///Grayscale conversion / copying
    ...
    template<typename T>
    static typename itk::ImportImageFilter<T, ImageProcessing::ImageDimension>::Pointer Dream3DtoITKImportFilter(VolumeDataContainer* m, QString attrMatName, T* data)
    {
    ...
    template<typename T>
    static typename itk::Image<T,ImageProcessing::ImageDimension>::Pointer Dream3DtoITK(VolumeDataContainer* m, QString attrMatName, T* data)
    {
     ...
     */
    template<typename T>
    static typename RGBImageType::Pointer Dream3DRGBtoITK(VolumeDataContainer* m, QString attrMatName, T* data)
    {
      //get size+dimensions of dataset
      size_t udims[3] =
      { 0, 0, 0 };
