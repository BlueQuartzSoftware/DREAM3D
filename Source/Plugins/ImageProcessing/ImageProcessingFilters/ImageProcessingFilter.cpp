...
//
// -----------------------------------------------------------------------------
void ImageProcessingFilter::setupFilterParameters()
{
...
//
// -----------------------------------------------------------------------------
void ImageProcessingFilter::readFilterParameters(AbstractFilterParametersReader* reader, int index)
{
...
//
// -----------------------------------------------------------------------------
void ImageProcessingFilter::preflight()
{
...
//
// -----------------------------------------------------------------------------
void ImageProcessingFilter::execute()
{
  int err = 0;
...
AbstractFilter::Pointer ImageProcessingFilter::newFilterInstance(bool copyFilterParameters)
{
  ...
  */
  ImageProcessingFilter::Pointer filter = ImageProcessingFilter::New();
