...
#ifndef _MeanKernel_H_
#define _MeanKernel_H_
...
/**
 * @class MeanKernel MeanKernel.h ImageProcessing/Code/ImageProcessingFilters/MeanKernel.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class MeanKernel : public AbstractFilter
{
  public:
    DREAM3D_SHARED_POINTERS(MeanKernel);
    DREAM3D_STATIC_NEW_MACRO(MeanKernel);
    DREAM3D_TYPE_MACRO_SUPER(MeanKernel, AbstractFilter);
    ...
    */
    virtual const std::string getHumanLabel() { return "Mean (Kernel)"; }
  ...
  private:
    ...
    MeanKernel(const MeanKernel&); // Copy Constructor Not Implemented
    void operator=(const MeanKernel&); // Operator '=' Not Implemented
};
