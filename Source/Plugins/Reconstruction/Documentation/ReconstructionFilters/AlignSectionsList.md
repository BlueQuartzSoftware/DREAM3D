...
If the alignment file was generated by another DREAM.3D Alignment Filter then the DREAM.3D Alignment File format option should be turned on and the format of the first 6 columns of each row of the file should be as follows:
