...
/**
 * @class VoxelDataContainerReader VoxelDataContainerReader.h Version4Compatibility/Version4CompatibilityFilters/VoxelDataContainerReader.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class VoxelDataContainerReader : public AbstractFilter
{
