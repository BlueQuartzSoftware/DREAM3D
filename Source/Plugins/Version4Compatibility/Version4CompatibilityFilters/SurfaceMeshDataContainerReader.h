...
/**
 * @class SurfaceMeshDataContainerReader SurfaceMeshDataContainerReader.h Version4Compatibility/Version4CompatibilityFilters/SurfaceMeshDataContainerReader.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class SurfaceMeshDataContainerReader : public AbstractFilter
{
