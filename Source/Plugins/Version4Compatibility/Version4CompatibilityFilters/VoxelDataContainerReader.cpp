...
//
// -----------------------------------------------------------------------------
void VoxelDataContainerReader::dataCheck()
{
  setErrorCondition(0);
...
//
// -----------------------------------------------------------------------------
const QString VoxelDataContainerReader::getCompiledLibraryName()
{
...
//
// -----------------------------------------------------------------------------
const QString VoxelDataContainerReader::getGroupName()
{
...
//
// -----------------------------------------------------------------------------
const QString VoxelDataContainerReader::getHumanLabel()
{
  return "VoxelDataContainerReader";
}

// -----------------------------------------------------------------------------
//
// -----------------------------------------------------------------------------
const QString VoxelDataContainerReader::getSubGroupName()
{
  return "Misc";
}
...
//
// -----------------------------------------------------------------------------
AbstractFilter::Pointer VoxelDataContainerReader::newFilterInstance(bool copyFilterParameters)
{
  /*
  * write code to optionally copy the filter parameters from the current filter into the new instance
  */
  VoxelDataContainerReader::Pointer filter = VoxelDataContainerReader::New();
