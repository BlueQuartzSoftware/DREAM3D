...
#ifndef _V4DataContainerReader_H_
#define _V4DataContainerReader_H_
...
/**
 * @class V4DataContainerReader V4DataContainerReader.h Version4Compatibility/Version4CompatibilityFilters/V4DataContainerReader.h
 * @brief
 * @author
 * @date
 * @version 1.0
 */
class V4DataContainerReader : public AbstractFilter
{
    Q_OBJECT /* Need this for Qt's signals and slots mechanism to work */

  public:
    DREAM3D_SHARED_POINTERS(V4DataContainerReader)
    DREAM3D_STATIC_NEW_MACRO(V4DataContainerReader)
    DREAM3D_TYPE_MACRO_SUPER(V4DataContainerReader, AbstractFilter)

    virtual ~V4DataContainerReader();
  ...
  private:
    ...
    V4DataContainerReader(const V4DataContainerReader&); // Copy Constructor Not Implemented
    void operator=(const V4DataContainerReader&); // Operator '=' Not Implemented
};

#endif /* _V4DataContainerReader_H_ */
