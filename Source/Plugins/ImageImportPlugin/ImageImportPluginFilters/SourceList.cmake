...
foreach(f ${_PublicFilters} )
  ADD_DREAM3D_FILTER(  "ImageImportPlugin" "ImageImportPlugin"
                        ${_filterGroupName} ${f}
                        ${ImageImportPlugin_SOURCE_DIR}/Documentation/${_filterGroupName}/${f}.md TRUE)
endforeach()
...
END_FILTER_GROUP(${ImageImportPlugin_BINARY_DIR} "${_filterGroupName}" "Image Import Filters")
