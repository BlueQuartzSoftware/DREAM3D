...
set(DREAM3DLib_DataArrays_HDRS
  ...
  ${DREAM3DLib_SOURCE_DIR}/DataArrays/GbcdDataArray.hpp
...
cmp_IDE_SOURCE_PROPERTIES( "DREAM3DLib/DataArray" "${DREAM3DLib_DataArrays_HDRS}" "${DREAM3DLib_DataArrays_SRCS}" "0")
if( ${PROJECT_INSTALL_HEADERS} EQUAL 1 )
    INSTALL (FILES ${DREAM3DLib_DataArrays_HDRS}
            DESTINATION include/DREAM3D/DataArray
            COMPONENT Headers   )
endif()
