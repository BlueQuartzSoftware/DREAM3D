...
ADD_DREAM3D_SUPPORT_HEADER(${DREAM3D_FILTER_GROUP_NAME} util/Vector3.h)
ADD_DREAM3D_SUPPORT_SOURCE(${DREAM3D_FILTER_GROUP_NAME} util/Vector3.cpp)

ADD_DREAM3D_SUPPORT_HEADER(${DREAM3D_FILTER_GROUP_NAME} util/Plane.h)
ADD_DREAM3D_SUPPORT_SOURCE(${DREAM3D_FILTER_GROUP_NAME} util/Plane.cpp)

ADD_DREAM3D_SUPPORT_HEADER(${DREAM3D_FILTER_GROUP_NAME} util/TriangleOps.h)
ADD_DREAM3D_SUPPORT_SOURCE(${DREAM3D_FILTER_GROUP_NAME} util/TriangleOps.cpp)

ADD_DREAM3D_SUPPORT_HEADER(${DREAM3D_FILTER_GROUP_NAME} util/Exception.h)
ADD_DREAM3D_SUPPORT_HEADER(${DREAM3D_FILTER_GROUP_NAME} util/InvalidParameterException.h)
if(EIGEN_FOUND)
