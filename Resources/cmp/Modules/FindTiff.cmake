...
IF(TIFF_INCLUDE_DIR AND TIFF_LIBRARY)
  ...
  IF (TIFF_LIBRARY_DEBUG)
    ...
    SET(TIFF_LIBRARY_DIR  ${TIFF_LIBRARY_PATH} CACHE FILEPATH "Path to Tiff Library Directory")
  ...
  IF (TIFF_DUMP_PROG)
    ...
    SET(TIFF_BINARY_DIR  ${TIFF_BIN_PATH} CACHE FILEPATH "Path to Tiff Binary Directory")
