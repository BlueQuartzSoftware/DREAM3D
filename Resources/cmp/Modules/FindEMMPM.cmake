...
IF(EMMPM_INCLUDE_DIR AND EMMPM_LIBRARY)
  ...
  IF (EMMPM_LIBRARY_DEBUG)
    ...
    SET(EMMPM_LIBRARY_DIR ${EMMPM_LIBRARY_PATH} CACHE FILEPATH "Path to EMMPM Library Directory")
  ...
  IF (EMMPM_PROG)
    ...
    SET(EMMPM_BINARY_DIR  ${EMMPM_BIN_PATH} CACHE FILEPATH "Path to EMMPM Binary Directory")
  ENDIF (EMMPM_PROG)
