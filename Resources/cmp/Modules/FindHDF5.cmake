...
IF(HDF5_INCLUDE_DIR AND HDF5_LIBRARY)
  ...
  IF (HDF5_LIBRARY_DEBUG)
    ...
    SET(HDF5_LIBRARY_DIR  ${HDF5_LIBRARY_PATH} CACHE FILEPATH "Path to HDF5 Library Directory")
  ...
  IF (HDF5_DUMP_PROG)
    ...
    SET(HDF5_BINARY_DIR  ${HDF5_BIN_PATH} CACHE FILEPATH "Path to HDF5 Binary Directory")
