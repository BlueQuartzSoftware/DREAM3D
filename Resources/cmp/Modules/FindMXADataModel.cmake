...
IF(MXADATAMODEL_INCLUDE_DIR AND MXADATAMODEL_LIBRARY)
  ...
  SET(MXADATAMODEL_LIBRARY_DIR ${MXADATAMODEL_LIBRARY_PATH} CACHE FILEPATH "MXADataModel Library Directory")
  ...
  IF (MXADATAMODEL_IMPORT_GENERATOR_PROG)
    ...
    SET(MXADATAMODEL_BINARY_DIR ${MXADATAMODEL_BIN_PATH} CACHE FILEPATH "MXADataModel Binary Directory")
  ENDIF (MXADATAMODEL_IMPORT_GENERATOR_PROG)
  
 # if (NOT MXADATAMODEL_RESOURCES_DIR)
    GET_FILENAME_COMPONENT(mxa_install ${MXADATAMODEL_LIBRARY_DIR} PATH)
