...
IF(MXADATAMODEL_INCLUDE_DIR AND MXADATAMODEL_LIBRARY)
  ...
  IF (MXADATAMODEL_LIBRARY_DEBUG)
    ...
    SET(MXADATAMODEL_LIBRARY_DIR ${MXADATAMODEL_LIBRARY_PATH} CACHE FILEPATH "Path to MXADataModel Library Directory")
  ...
  IF (MXADATAMODEL_IMPORT_GENERATOR_PROG)
    ...
    SET(MXADATAMODEL_BINARY_DIR  ${MXADATAMODEL_BIN_PATH}  CACHE FILEPATH "Path to MXADataModel Binary Directory")
