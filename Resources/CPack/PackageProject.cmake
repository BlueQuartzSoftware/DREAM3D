...
IF (APPLE)
    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${DREAM3DLib_VERSION}-OSX")
elseif(WIN32)
	if ( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${DREAM3DLib_VERSION}-Win64")
	elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${DREAM3DLib_VERSION}-Win32")
	else()
	    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${DREAM3DLib_VERSION}-Unknown")
    endif()
else()
  set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${DREAM3DLib_VERSION}-${CMAKE_SYSTEM_NAME}")
endif()
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "DREAM.3D-${DREAM3DLib_VERSION}-Source")
