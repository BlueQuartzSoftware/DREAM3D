...
set(CPACK_PACKAGE_EXECUTABLES
    ${SIMPLView_APPLICATION_NAME} ${SIMPLView_APPLICATION_NAME} DevHelper DevHelper)
set(UPLOAD_FILE_NAME "")

if(APPLE)
    set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-OSX")
...
elseif(WIN32)
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-Win64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-Win32")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    else()
        set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-Unknown")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.zip)
    endif()
else()
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-${DREAM3D_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-${DREAM3D_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
        set(CPACK_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-${CMAKE_SYSTEM_NAME}")
        set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    endif()
endif()
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "${SIMPLView_APPLICATION_NAME}-${DREAM3D_VERSION_SHORT}-Source")
